...
{
    public class ProjectileRaySegGen : BaseRaySegmentGenerator
    {
        ...
        public override float velocity
        {
            ...
            set { if (m_velocity != value) { m_velocity = value; CalculatePeekDistanceMax(); } }
        }

        public override Vector3 gravity
        {
            get { return m_gravity; }
            set { if (m_gravity != value) { m_gravity = value; CalculateAcc(); CalculatePeekDistanceMax(); } }
        }

        public ProjectileRaySegGen(Transform transform) : base(transform)
        {
            CalculateAcc();
        ...
        {
            accY = -m_gravity.magnitude;
        }

        private void CalculatePeekDistanceMax()
        {
            maxHalfJourney = 0.5f * m_velocity * m_velocity / Mathf.Abs(accY);
        }
        ...
        public override void Reset()
        {
            ...
            v0 = transform.forward * m_velocity;
